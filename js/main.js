...
var truethrills;
var truefreedom;
var playerDefaults = { playsinline: 1, autoplay: 1, autohide: 1, modestbranding: 0, rel: 0, showinfo: 0, controls: 1, disablekb: 1, enablejsapi: 0, iv_load_policy: 3, mute: 1 };
...
// firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);
// var tv,
//     playerDefaults = { playsinline: 1, autoplay: 1, autohide: 1, modestbranding: 0, rel: 0, showinfo: 0, controls: 0, disablekb: 1, enablejsapi: 0, iv_load_policy: 3, playlist: 'PVTzLJfW0LY', mute: 1 };

// function onYouTubePlayerAPIReady() {
//     tv = new YT.Player('tv', { videoId: 'PVTzLJfW0LY', events: { 'onReady': onPlayerReady, 'onStateChange': onPlayerStateChange }, playerVars: playerDefaults });
// }
...
$(document).ready(function() {
    ...
    $('#widget-dropdown').on('change', function() {
        ...
        console.log('weather widget located')


    });


            // WEATHER WIDGET LINKED TO THE LOCATIONS LIST
